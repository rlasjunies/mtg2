...
module mtg.register {
    "use strict";
    export class ValidateEqualsDirective implements angular.IDirective {
        require = "ngModel";
        link = function (scope: angular.IScope, instanceElement: angular.IAugmentedJQuery,
            attrs: angular.IAttributes, controller: angular.INgModelController) {
