...
describe("Users guest user", () => {
    ...
    describe(usersUrl, function () {
            ...
            agent.get(usersUrl)
                ...
                .end((err, resp) => {
                    if (err) {
                        ...
                        expect(err).toBeNull();
                        expect(resp.status).toEqual(403); // res.should.have.status(200);
        ...
        it("should - NOT be authorized to - add user", (done) => {
...
//         it("should - NOT be authorized to - have 1 more user", function (done) {
//             agent.get(usersUrl)
//                 .set("authorization", token)
//             
//                 .end((err, resp: sa.Response) => {
...
//         });
        ...
        it("should - NOT be authorized to - find user by id:", (done) => {
...
//                         expect(paint).to.deep.equal(newUser);
        ...
        it("should - NOT be authorized to - remove user by id:", (done) => {
