...
import $userCol = require("../shared/user");
            ...
            agent.post(usersUrl).
                ...
                .end((err, resp: sa.Response) => {
                    if (err) {
                        ...
                        expect(doc._id).toBeDefined()  //mocha to.be.not.Empty;
                        usersDocID = doc._id;
                        ...
                        //mocha expect(doc).to.deep.equal(newUser);
                        expect(doc).toEqual(newUser);
                        done();
                    }
                });
        });
            ...
            agent.get(usersUrl)
                ...
                .end((err, resp: sa.Response) => {
                    if (err) {
                        ...
                        //mocha expect(listOfUsers).to.be.a("Array");
                        expect(listOfUsers.length).toEqual(usersInitialLenght + 1);
            ...
            agent.get(usersUrl + "/" + usersDocID).
                ...
                .end((err, resp: sa.Response) => {
                    if (err) {
                        ...
                        //mocha expect(paints).to.be.a("Array");
                        expect(paints.length).toEqual(1);
                        var paint = paints[0];
            ...
            agent.del(usersUrl + "/" + usersDocID).
                ...
                .end((err, resp: sa.Response) => {
                    if (err) {
                        ...
                        delete paint._id;
                        delete paint.__v;
                        //mocha expect(paint).to.deep.equal(newUser);
                        expect(paint).toEqual(newUser);
                        done();
                    }
                });
            ...
            agent.get(usersUrl)
                ...
                .end((err, resp: sa.Response) => {
                    if (err) {
                        ...
                        var listOfUsers = <$userCol.IUserDocument[]>resp.body;
                        //mocha expect(listOfUsers).to.be.a("Array");
                        expect(listOfUsers.length).toEqual(usersInitialLenght);
